...
NEW_AUDIO_FEATURES_RAW_CSV = './datasets/predictions/va/new_audio_features_raw.csv'
NEW_AUDIO_PREDICTED_VA_CSV = './datasets/predictions/va/new_audio_predicted_va.csv'
NEW_AUDIO_DESCRIPTOR_SCORES_CSV = './datasets/predictions/va/new_audio_descriptor_scores.csv'
